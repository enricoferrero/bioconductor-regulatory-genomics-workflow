...
author:
  affiliation: Computational Biology, GSK, Medicines Research Centre, Gunnels Wood
...
```{r manhattan, fig.cap = 'Manhattan plot showing variants significantly associated with SLE.', fig.height = 7, fig.width = 6}
library(ggplot2)
