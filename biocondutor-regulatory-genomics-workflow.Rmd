---
title: "Using regulatory genomics data to intepret the function of disease variants and prioritise genes from expression studies"
author:
...
For simplicity, we will skip this LD expansion step and refer the reader to the Ensembl REST API [@Yates2015], the [Ensembl Linkage Disequilibrium Calculator](http://www.ensembl.org/Homo_sapiens/Tools/LD?db=core) and the Bioconductor packages `trio` [@Schwender2015] and `ldblock` [@Carey2017c] to perform this task.
...
We can build this using the `GenomicFeatutres` [@Lawrence2013] package and the GENCODE v25 gene annotation:
